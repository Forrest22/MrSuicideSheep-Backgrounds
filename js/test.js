...
$(function() {
    ...
    var el = document.getElementById('image-grid'),
        ...
        updateGrid = function(event, ui) {
            ...
            grid.updateTiles(TILE_IDS.slice(0, TILE_IDS.length-1));
    ...
    grid.createTile = function(tileId) {
        ...
        $.getJSON('https://gdata.youtube.com/feeds/api/videos?author=MrSuicideSheep&index-start='+(i+1)+'max-results=1&v=2&alt=jsonc&orderby=published', function(ytdata) {
