...
$(function() {
    ...
    updateGrid = function(event) {
        ...
        grid.createTile = function(tileId) {
            ...
            //console.log($.getJSON('https://gdata.youtube.com/feeds/api/videos?author=MrSuicideSheep&q='+query+'&start-index='+startIndex+'&max-results=25&v=2&alt=jsonc&orderby=published');
